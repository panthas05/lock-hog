...
import lock_hog
from lock_hog.asynchronous.async_hog_lock import HoggerStillAlive
...
class TestHogLockFromThread(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_raises_lock_hogging_thread_is_still_alive_after_timeout(
        self,
    ) -> None:
